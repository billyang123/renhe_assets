    ...
    <div class="reg-container">
      ...
      <section>
        <form class="rh-form rh-form-horizontal">
          <div class="rh-form-group">
            <div class="rh-u-sm-12 clearfix reg-email-ipt">
              <input type="text"  value="2897555081" style="width:50%;" class="rh-fl"><span class="rh-fl">@</span><input class="rh-fl" type="text"  value="qq.com" style="width:30%;">
            </div>
          ...
          <div class="rh-form-group">
            <div class="rh-text-center">
              <button type="submit" class="rh-btn rh-btn-purple rh-radius-r" style="width:80%;">导入联系人</button>
            </div>
          </div>
        </form>
        <div class="rh-text-center">
    ...
    <div class="reg-container">
      ...
      <div id="slider">
          <div class="slider-content">
            <ul class="rh-list reg-contacts-list">
          ...
          <div class="reg-option clearfix">
            <i class="rh-icon-check-circle rh-fl reg-list-icon rh-icon-md"></i>
            <strong class="rh-fl">全选</strong>
            <button class="rh-btn rh-btn-purple rh-radius rh-fr">发送（50/50）</button>
          </div>
      </div>
      </section>
